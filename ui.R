        ...
        sidebarMenu(
          ...
          convertMenuItem(menuItem("Analysis",  tabName="analysis", icon=icon("flask"),
                                   ...
                                   p(a("Example Phosphoproteomics data", target= "_blank",
                                       href="data/Phospho (STY)Sites.txt", 
                                       download="Phospho (STY)Sites.txt")),
                                   p(a("Example Experimental Design file", target= "_blank",
                                       href="data/exp_design_p16_0022.txt", 
                                       download="exp_design_p16_0022.txt"))
          ), tabName = 'analysis'),
          convertMenuItem(
                                        ...
                                        tabPanel("ProteinPage",
                                                 fluidRow(
                                                   ...
                                                   box(
                                                     ...
                                                     width = 4)),
                                                 # align save button
                                                 tags$style(type='text/css', "#downloadButton_pr { width:100%; margin-top: 25px;}"), 
                                                 tags$style(type='text/css', "#downloadreport_pr { width:100%; vertical-align- middle; margin-top: 25px;
                                                                    margin-bottom: 25px;}"),
                                                 tags$br(), # Blank lines
                                                 tags$br(),
                                                 ## Data table and result plots box
