                      ...
                      fluidPage(
                        box(
                          ...
                          tags$ul(
                            ...
                            tags$li("Upload your ", tags$b("phosphosite experimental design "),"table or ",
                                    # editable table for phosphosite data
                                    actionButton("showTable", "Create phosphosite design", icon = icon("table")),
                                    bsModal("modal", "Interactive phosphosite experiment design table", "showTable", size = "large",
                                            ...
                                            downloadButton('save_exp', 'Download')),"."), 
                            
                            tags$li("Upload your ", tags$b(" Protein Group.txt "),"generated by MaxQuant. "), 
                            tags$li("Upload your ", tags$b("protein experimental design "),"table or ",
                                    # editable table for phosphosite data
                                    actionButton("showTable_pr", "Create protein design", icon = icon("table")),
                                    bsModal("modal_pr", "Interactive protein experiment design table", "showTable_pr", size = "large",
                                            ...
                                            actionButton("save_exp_pr","Download")), "."), 
